...
- [x] **Step 1: Write failing crawler and template-path tests**
...
- [x] **Step 3: Implement crawler detection, origin normalization, and path resolution**
...
- [x] **Step 4: Write failing preview-content tests**
...
- [x] **Step 5: Implement preview formatting**
...
- [x] **Step 6: Write failing metadata injection tests**
...
- [x] **Step 7: Implement idempotent HTML injection**
...
- [x] **Step 2: Add visibility and fallback tests**
...
- [x] **Step 5: Replace the inline petition SSR block**
...
- [x] **Step 6: Run route and regression tests**
...
- [x] **Step 3: Verify the production path against built files**
...
- [x] **Step 5: Commit any final test-only refinement**
