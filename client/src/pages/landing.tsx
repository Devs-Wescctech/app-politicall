...
import crmImage from "@assets/targeted_element_1763466718021.png";
import alliancesImage from "@assets/targeted_element_1763404600946.png";
import demandsImage from "@assets/image_1763317809776.png";
import eventsImage from "@assets/targeted_element_1763308961981.png";
import aiImage from "@assets/dsfsdfdsfdsfdsf_1763412976580.png";
import surveysImage from "@assets/image_1765985939016.png";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <motion.header 
        className={`fixed top-0 left-0 right-0 z-50 ${isScrolled ? 'border-b bg-background/95 backdrop-blur-sm' : ''}`}
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <button onClick={() => scrollToSection('ia')} className={`text-sm hover:text-primary transition-colors ${!isScrolled ? 'text-white' : 'text-foreground'}`} data-testid="button-nav-ia">
                IA para Redes Sociais
              </button>
              <button onClick={() => scrollToSection('modulos')} className={`text-sm hover:text-primary transition-colors ${!isScrolled ? 'text-white' : 'text-foreground'}`} data-testid="button-nav-modulos">
                Módulos
              </button>
              ...
              <Button variant="outline" size="sm" className={`rounded-full w-32 ${!isScrolled ? 'text-white !border-white hover:bg-white/10' : ''}`} onClick={() => scrollToSection('contato')} data-testid="button-header-cta">
                Começar Agora
              </Button>
            </nav>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <img 
                ...
                className="w-full h-auto max-w-sm mx-auto cursor-pointer hover:opacity-90 transition-opacity dark:invert dark:hue-rotate-180 dark:saturate-50"
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <img 
                  src={wesccLogo} 
                  alt="Wescc Tech" 
                  className="h-6 md:h-8 inline-block invert dark:invert-0"
